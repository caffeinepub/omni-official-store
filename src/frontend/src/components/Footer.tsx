import { Diamond, PhoneCall } from "lucide-react";
        ...
        <div className="flex items-center justify-center gap-3">
          {socialLinks.map((social) => (
            <a
              ...
              className={`w-8 h-8 flex items-center justify-center rounded-full bg-muted hover:bg-muted/80 text-muted-foreground ${social.hoverColor} transition-colors duration-200`}
            >
              {social.icon}
